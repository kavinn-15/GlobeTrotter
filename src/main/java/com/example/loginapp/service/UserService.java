...
public class UserService {
    ...
    /**
     * Applies edits from the "Edit Profile" screen to the persisted user
     * row and returns the freshly-saved entity (so the controller can put
     * an up-to-date copy back on the session).
     */
    public User updateProfile(Long userId, String firstName, String lastName, String email,
                               ...
                               String additionalInfo, String photoPath) {
